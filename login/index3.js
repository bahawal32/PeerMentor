...
io.sockets.on('connection', function(socket){
    ...
    socket.on('send message' , function(data){
            ...
            io.emit('new message' , {msg: user+':'+msg});
            ...
            db.collection('chat')
                .insertOne(insertJson2,function(error,res){
                    //esponse.json('chat entry success');
                    console.log('chat entry success');
                });
    ...
    socket.on('broadcast' , function(data){
            ...
            var user = array[3];
            var type = parseInt(array[6].charAt(1));
            var msg = array[9];
            ...
            db.collection('broadcast')
                .insertOne(insertJson1,function(error,res){
                    //response.json('broadcast success');
